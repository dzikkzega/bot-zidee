...
async function addlistCommand(sock, chatId, message, args, imageBuffer = null, mimetype = null) {
    try {
        // Check if group
...
💡 Hanya admin grup yang dapat mengelola product list.`
        ...
        const productDescription = parts[1].trim();
...
💡 Atau \`dellist ${productName}\` untuk hapus`
        ...
        // Add product
        const newProduct = addProduct(chatId, productName, productDescription, imageBuffer, mimetype);
